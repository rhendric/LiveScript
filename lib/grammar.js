...
bnf = {
  ...
  Block: [
    o('INDENT Lines DEDENT', function(){
      return $2;
    }), o('INDENT ASCR Expression DEDENT', function(){
      return Block().addType($3);
    }), o('INDENT ASCR Expression NEWLINE Lines DEDENT', function(){
      return $5.addType($3);
  ...
  Expression: [
    ...
    }), o('Expression ASCR Expression', function(){
      return $1.addType($3);
    })
  ],
  Exprs: [
